      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn" style="background-color:#AC0818; color:white;" data-dismiss="modal">Verder winkelen</button>
            <button type="button" class="btn" style="background-color:#64A425; color:white;" @click="checkout">Naar de kassa</button>
          </div>
        </div>
      </div>
    </div>
