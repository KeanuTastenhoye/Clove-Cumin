<template>
  <div class="rubs">
    ...
    <div class="container pb-5">
      ...
      <div class="row">
        <div class="col">
              <div id="bannerRubs" class="carousel pb-3" data-ride="carousel">
                <ol class="carousel-indicators">
                  <li data-target="#bannerRubs" data-slide-to="0" class="active"></li>
                  <li data-target="#bannerRubs" data-slide-to="1"></li>
                  <li data-target="#bannerRubs" data-slide-to="2"></li>
                  <li data-target="#bannerRubs" data-slide-to="3"></li>
                  <li data-target="#bannerRubs" data-slide-to="4"></li>
                </ol>
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="card-img-top image" src="/img/spicemixes.jpg" alt="Card image" style="width: 100; margin-left: auto; margin-right: auto;">
                  </div>
                  <div class="carousel-item">
                    <img class="card-img-top image" src="/img/spicemixes-1.jpg" alt="Card image" style="width: 100; margin-left: auto; margin-right: auto;">
                  </div>
                  <div class="carousel-item">
                    <img class="card-img-top image" src="/img/spicemixes-2.jpg" alt="Card image" style="width: 100; margin-left: auto; margin-right: auto;">
                  </div>
                  <div class="carousel-item">
                    <img class="card-img-top image" src="/img/spicemixes-3.jpg" alt="Card image" style="width: 100; margin-left: auto; margin-right: auto;">
                  </div>
                  <div class="carousel-item">
                    <img class="card-img-top image" src="/img/spicemixes-4.jpg" alt="Card image" style="width: 100; margin-left: auto; margin-right: auto;">
                  </div>
                </div>
                <a class="carousel-control-prev" href="#bannerRubs" role="button" data-slide="prev">
                  <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                  <span class="sr-only">Previous</span>
                </a>
                <a class="carousel-control-next" href="#bannerRubs" role="button" data-slide="next">
            ...
            <div class="row">
              ...
              <div class="col text-center">
                ...
                <div v-for="gr in selectedRub.amountPrice" :key="gr">
                  <a v-if="gr[2] === true"><input type="radio" :id="gr" :value="gr" v-model="selectedRub.amountP" disabled></a>
                  <a v-if="gr[2] === true"><label class="pl-1" :for="gr" style="color:red; opacity: 0.5">{{gr[0]}} - € {{gr[1].toFixed(2)}}</label></a>
                  <a v-if="gr[2] === false"><input type="radio" :id="gr" :value="gr" v-model="selectedRub.amountP"></a>
